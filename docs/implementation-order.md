...
| B6.3.5 | TYRE-143 sweep remediation, slices R1–R4 (`docs/pre-b64-remediation.md`): TYRE-144/145/146 Critical plus the Important set the sweep names as blockers | one branch per slice | not cut; gates B6.4 |
