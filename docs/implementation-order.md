...
| B6.3.5 | TYRE-143 sweep remediation, slices R1–R4 (`docs/pre-b64-remediation.md`): TYRE-144/145/146 Critical plus the Important set the sweep names as blockers | `TYRE-144-immutable-history` (R1), `TYRE-146-capture-discard` (R2) | R1 merged 6 Sep 2026, PR #47; R2 in progress; R3–R4 not cut; gates B6.4 |
