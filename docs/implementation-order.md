...
| B6.4 | TYRE-75 — reconcile reported composition into a dated rig change | not cut | planning next — handoff `docs/HANDOFF_b64_planning.md` (gitignored); open inputs TYRE-222 (un-homed units, owner decision) and TYRE-226 (four unit-path writes unnarrowed) |
