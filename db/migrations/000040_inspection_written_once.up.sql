...
-- revoked (000001), but INSERT must stay granted, since it is how a capture
-- is written, and nothing tied that INSERT to the reading's own submit. One
...
-- relying on trigger order, as 000032 does, and uses the whole row so
