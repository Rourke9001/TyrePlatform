-- 000040 down: restores 000023's submit_inspection, 000001's tread CHECK
...
GRANT UPDATE ON app.inspection TO app_rw;
...
ALTER TABLE app.reading_measurement
  ...
  ADD CONSTRAINT reading_measurement_tread_mm_check CHECK (tread_mm BETWEEN 0 AND 35);
